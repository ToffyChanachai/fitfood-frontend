...
export default {
    ...
    methods: {
        async fetchPromotionTypes() {
            ...
            try {
                const response = await axios.get(`${API_URL}/seller-names`);
        ...
        async saveChanges() {
            try {
                await axios.put(`${API_URL}/seller-names/${this.selectedPromotionType.id}`, {
        ...
        async deleteConfirmed() {
            try {
                await axios.delete(`${API_URL}/seller-names/${this.itemToDelete}`);
        ...
        async addPromotionType() {
            ...
            try {
                const response = await axios.post(`${API_URL}/seller-names`, this.newPromotionType);
