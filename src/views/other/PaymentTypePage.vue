    ...
    <div class="mt-[-20px]">
        ...
        <div class="flex space-x-2 items-center relative">
            <div class="mt-4 px-4 flex items-center space-x-1 mr-auto ">
                ...
                <span class="text-m text-gray-700">จำนวนประเภทการชำระเงินทั้งหมด: </span>
                    ...
                    <div class="bg-white rounded-md shadow-lg w-1/2 max-w-3xl h-auto max-h-[800px] flex flex-col">
                        <div
                            ...
                            <div class="flex-1 flex items-left">
                                <span class="font-bold">เพิ่มประเภทการชำระเงิน</span>
                            </div>
            ...
            <div v-if="isEditModalOpen"
                ...
                <div class="bg-white rounded-md shadow-lg w-1/2 max-w-3xl h-auto max-h-[800px] flex flex-col">
                    <div class="flex justify-between items-center bg-custom-orange text-white px-4 py-2 rounded-t-md">
                        <span class="font-bold">แก้ไขประเภทการชำระเงิน</span>
                        <div class="flex space-x-2">
...
export default {
    ...
    methods: {
        ...
        async saveChanges() {
            try {
                await axios.put(`${API_URL}/payment-types/${this.selectedPromotionType.id}`, {
        ...
        async deleteConfirmed() {
            try {
                await axios.delete(`${API_URL}/payment-types/${this.itemToDelete}`);
        ...
        async addPromotionType() {
            ...
            try {
                const response = await axios.post(`${API_URL}/payment-types`, this.newPromotionType);
