    ...
    <div>
        ...
        <div class="mt-4">
            <div class="flex items-center">
                <h1 class="text-xl font-bold">ประวัติการสั่งซื้อแพ็คเกจ: </h1>
            ...
            <div v-else>
                <div v-if="saleRecords.length > 0"
                    ...
                    <div v-for="saleRecord in saleRecords" :key="saleRecord.start_package_date"
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <div class="text-gray-600">วันเริ่มแพ็กเกจ: {{ formattedDate(saleRecord.start_package_date) }}</div>
                        </div>
                ...
                <div v-if="saleRecords.length === 0"
                    ...
                    <div class="flex items-center space-x-1 text-gray-500 font-bold text-center">
                        ...
                        <span class="text-xl">ไม่มีประวัติการสั่งซื้อแพ็คเกจ</span>
                    </div>
                </div>
            </div>
