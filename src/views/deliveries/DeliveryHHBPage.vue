      ...
      <table class="report-content min-w-full table-auto mt-4 p-4">
        <thead>
          <tr class="bg-gray-100 text-black text-[12px]">
            <th class="px-6 py-3 text-left font-bold border-b border-b-black" style="width: 25%;">ชื่อ - นามสกุล</th>
            ...
            <th class="px-6 py-3 text-left font-bold border-b border-b-black" style="width: 30%;">ที่อยู่จัดส่ง</th>
          </tr>
...
export default {
  ...
  data() {
    return {
      ...
      headerWidths: ["5%", "15%", "10%", "10%", "10%", "15%", "30%", "5%"],
