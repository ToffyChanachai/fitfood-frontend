...
export default {
  ...
  methods: {
    async fetchSetupMenus() {
      ...
      try {
        const response = await fetch(`${API_URL}/setup-menu-hhb`);
    ...
    async fetchSetupMenusForToday() {
      try {
        ...
        const response = await axios.get(
          `${API_URL}/setup-menu-hhb/menus-by-day/${todayDate}`
        );
    ...
    async fetchMenusByDay() {
      ...
      try {
        const response = await axios.get(
          `${API_URL}/setup-menu-hhb/menus-by-day/${this.selectedDate}`
        );
    ...
    async fetchStartDate() {
      try {
        const response = await axios.get(
          `${API_URL}/setup-menu-hhb/get-start-date`
        );
    ...
    async updateStartDate() {
      try {
        ...
        const response = await axios.post(
          `${API_URL}/setup-menu-hhb/set-start-date`,
          {
    ...
    async addMenus() {
      try {
        ...
        await axios.post(`${API_URL}/setup-menu-hhb`, {
    ...
    async saveChanges() {
      try {
        ...
        await axios.put(
          `${API_URL}/setup-menu-hhb/${this.selectedSetupMenu.id}`,
          {
        ...
        // const response = await axios.put(`${API_URL}/setup-menu-hhb/${this.selectedSetupMenu.id}`, {
        //   day_of_week: this.selectedSetupMenu.day_of_week,
        //   menu_id: this.selectedSetupMenu.menu_id.id,
        // });
    ...
    async deleteConfirmed() {
      try {
        await axios.delete(
          `${API_URL}/setup-menu-hhb/${this.itemToDelete}`
        );
