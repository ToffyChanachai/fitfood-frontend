...
export default {
    ...
    methods: {
        ...
        async fetchZoneDeliveries() {
            ...
            try {
                const response = await axios.get(`${API_URL}/zone-deliveries`);
        ...
        async saveChanges() {
            try {
                ...
                const response = await axios.put(`${API_URL}/zone-deliveries/${this.selectedZoneDelivery.id}`, {
        ...
        async deleteConfirmed() {
            try {
                await axios.delete(`${API_URL}/zone-deliveries/${this.itemToDelete}`);
        ...
        async addzoneDelivery() {
            ...
            try {
                const response = await axios.post(`${API_URL}/zone-deliveries`, {
