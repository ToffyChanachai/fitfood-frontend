...
export default {
  ...
  methods: {
    ...
    async updateQuantity(Order) {
      try {
        await axios.put(`${API_URL}/orders-hhb/${Order.id}`, {
    ...
    async deleteConfirmed() {
      try {
        await axios.delete(`${API_URL}/orders-hhb/${this.itemToDelete}`);
    ...
    async addOrder() {
      ...
      try {
        const response = await axios.post(`${API_URL}/orders-hhb-add`, {
